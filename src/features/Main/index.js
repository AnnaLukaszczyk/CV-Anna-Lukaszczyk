				...
				<Section
					...
					content={[
						<Description>
							...
							frontend. Brak możliwości rozwoju w poprzedniej pracy skłonił mnie
							do zmiany branży: nie lubię tkwić w miejscu, a w każdym wyzwaniu
							widzę możliwości rozwoju. Uważam, że nie ma problemu, którego nie
							da się rozwiązać. Dążę do pracy w dynamicznym zespole, w którym
